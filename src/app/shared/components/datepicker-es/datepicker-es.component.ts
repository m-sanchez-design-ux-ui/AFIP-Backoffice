...
@Component({
  selector: 'app-datepicker-es',
  standalone: true,
  imports: [CommonModule, FeatherModule],
  providers: [DatePipe],
  templateUrl: './datepicker-es.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DatepickerEsComponent implements OnInit {
    ...
    flatpickr('#datePickerStart', {
      ...
      onChange: (selectedDates) => {
        ...
        if (this.endDate() !== 'dd/mm/aaaa') {
          const isStartDateBeforeEndDate = this.isStartDateBeforeEndDate(dateStart!, this.endDate());
